...
enum StandardBodyGenerator {
    ...
    private static func buildTorso(
        ...
        let slices: [(y: Float, rx: Float, rz: Float, region: BodyRegion, w: Float)] = [
            ...
            (132, 20.5, 11.0,  .bust,      0.8),
            (129, 20.8, 11.5,  .bust,      0.95),
            (126, 20.5, 11.8,  .bust,      1.0),   // バスト最大
            (123, 19.5, 11.5,  .bust,      0.9),
            // アンダーバスト→ウエスト：断面をなだらかなS字で繋ぐ
            (121, 18.8, 11.2,  .underBust, 0.85),
            (119, 18.0, 11.0,  .underBust, 0.85),
            (117, 17.2, 10.8,  .underBust, 0.8),
            (115, 16.5, 10.5,  .underBust, 0.7),
            (113, 16.0, 10.3,  .waist,     0.9),
            (111, 15.5, 10.2,  .waist,     1.0),   // ウエスト最細
            (109, 15.5, 10.2,  .waist,     1.0),
            // ウエスト→ヒップ：なだらかに広がる
            (107, 15.8, 10.2,  .abdomen,   0.75),
            (105, 16.2, 10.3,  .abdomen,   0.75),
            (103, 17.0, 10.4,  .abdomen,   0.78),
            (101, 18.0, 10.5,  .abdomen,   0.80),
            ( 99, 19.2, 10.5,  .hip,       0.85),
            ( 97, 20.2, 10.6,  .hip,       0.92),
            ( 96, 21.0, 10.7,  .hip,       1.0),   // ヒップ最大
            ( 94, 20.8, 10.6,  .hip,       0.97),
            ( 92, 20.2, 10.4,  .hip,       0.93),
            ( 90, 19.5, 10.2,  .hip,       0.85),
            ( 86, 17.5,  9.0,  .leg,       0.5),   // 脚上部（滑らかに移行）
            ( 82, 15.5,  8.5,  .leg,       0.4),
            ( 76, 14.0,  8.0,  .leg,       0.3),
        ]
