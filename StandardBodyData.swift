...
enum StandardBodyGenerator {
    ...
    private static func buildTorso(
        ...
        let slices: [(y: Float, rx: Float, rz: Float, region: BodyRegion, w: Float)] = [
            ...
            // ウエスト→ヒップ：rzはウエストと同程度に抑える（腰の突き出し防止）
            (105, 16.2,  8.5,  .abdomen,   0.75),
            (102, 17.2,  8.8,  .abdomen,   0.75),
            (100, 18.5,  9.2,  .abdomen,   0.80),
            ( 99, 20.0,  9.8,  .hip,       0.85),
            ( 96, 22.5, 10.5,  .hip,       1.0),
            ( 93, 22.0, 10.2,  .hip,       0.95),
            ( 90, 21.0,  9.8,  .hip,       0.85),
