...
enum StandardBodyGenerator {
    ...
    private static func buildTorso(
        ...
        let slices: [(y: Float, rx: Float, rz: Float, region: BodyRegion, w: Float)] = [
            ...
            // バスト：前後rzを抑えて薄めのトルソー形状に
            (135, 20.0,  9.5,  .bust,      0.7),
            (132, 20.5, 10.5,  .bust,      0.8),
            (129, 20.8, 11.5,  .bust,      0.95),
            (126, 20.5, 11.8,  .bust,      1.0),   // バスト最大
            (123, 19.5, 11.0,  .bust,      0.9),
            // アンダーバスト→ウエスト：自然にくびれる
            (120, 18.0,  9.8,  .underBust, 0.85),
            (117, 16.8,  9.2,  .underBust, 0.7),
            (114, 15.8,  9.0,  .waist,     0.9),
            (111, 15.5,  8.8,  .waist,     1.0),   // ウエスト最細
            (108, 15.5,  8.8,  .waist,     1.0),
            // ウエスト→ヒップ：rzは前後の厚みとして自然な値を維持
            (105, 15.9,  8.9,  .abdomen,   0.75),
            (102, 16.8,  9.0,  .abdomen,   0.75),
            (100, 18.0,  9.2,  .abdomen,   0.80),
            ( 99, 19.2,  9.3,  .hip,       0.85),  // ヒップ開始
            ( 96, 21.0,  9.5,  .hip,       1.0),   // ヒップ最大（rzは滑らかに増加）
            ( 93, 20.5,  9.3,  .hip,       0.95),
            ( 90, 19.5,  9.2,  .hip,       0.85),
