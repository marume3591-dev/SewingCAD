...
enum StandardBodyGenerator {
    ...
    private static func buildTorso(
        ...
        let slices: [(y: Float, rx: Float, rz: Float, region: BodyRegion, w: Float)] = [
            ...
            (155,  9.2,  9.2,  .neutral,   0.05),
            (152,  7.5,  7.0,  .neck,      0.5),
            (150,  6.5,  6.0,  .neck,      0.6),
            (148,  6.1,  5.7,  .neck,      0.7),
            (146,  5.8,  5.5,  .neck,      0.8),
            (144,  5.5,  5.2,  .neck,      0.9),
            // 肩
            (142, 10.0,  6.5,  .shoulder,  0.7),
            (141, 14.0,  7.5,  .shoulder,  0.8),
            (139, 17.0,  8.0,  .shoulder,  0.85),
            (138, 19.0,  8.5,  .shoulder,  0.9),
            // バスト（1cm刻み）
            (136, 19.5,  9.8,  .bust,      0.65),
            (135, 20.0, 10.5,  .bust,      0.7),
            (134, 20.3, 10.8,  .bust,      0.75),
            (133, 20.5, 11.0,  .bust,      0.8),
            (132, 20.6, 11.2,  .bust,      0.85),
            (131, 20.7, 11.4,  .bust,      0.9),
            (130, 20.8, 11.5,  .bust,      0.93),
            ...
            ( 88, 18.5,  9.8,  .leg,       0.6),
            ( 86, 17.5,  9.4,  .leg,       0.5),
            ( 84, 16.5,  9.0,  .leg,       0.45),
            ( 82, 15.5,  8.5,  .leg,       0.4),
            ( 79, 14.8,  8.2,  .leg,       0.35),
            ( 76, 14.0,  8.0,  .leg,       0.3),
        ]
