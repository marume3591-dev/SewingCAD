...
enum StandardBodyGenerator {
    ...
    private static func buildTorso(
        ...
        let slices: [(y: Float, rx: Float, rz: Float, region: BodyRegion, w: Float)] = [
            ...
            (154,  8.0,  7.8,  .neck,      0.4),
            (153,  7.2,  6.9,  .neck,      0.5),
            (152,  6.8,  6.5,  .neck,      0.55),
            (151,  6.5,  6.2,  .neck,      0.6),
            (150,  6.3,  6.0,  .neck,      0.65),
            (149,  6.1,  5.8,  .neck,      0.7),
            (148,  5.9,  5.6,  .neck,      0.75),
            (147,  5.7,  5.4,  .neck,      0.8),
            (146,  5.6,  5.3,  .neck,      0.85),
            (145,  5.5,  5.2,  .neck,      0.9),
            (144,  5.5,  5.2,  .neck,      0.9),
            // 首→肩（1cm刻みで滑らかに拡大）
            (143,  6.5,  5.5,  .shoulder,  0.6),
            (142,  8.5,  6.2,  .shoulder,  0.65),
            (141, 11.0,  6.8,  .shoulder,  0.7),
            (140, 13.5,  7.3,  .shoulder,  0.75),
            (139, 16.0,  7.8,  .shoulder,  0.8),
            (138, 18.0,  8.2,  .shoulder,  0.85),
            (137, 19.0,  8.8,  .shoulder,  0.9),
            // 肩→バスト（1cm刻み）
            (136, 19.3,  9.3,  .bust,      0.65),
            (135, 19.6,  9.8,  .bust,      0.7),
            (134, 19.9, 10.3,  .bust,      0.75),
            (133, 20.2, 10.7,  .bust,      0.8),
            (132, 20.4, 11.0,  .bust,      0.85),
            (131, 20.6, 11.2,  .bust,      0.9),
            (130, 20.7, 11.4,  .bust,      0.93),
            (129, 20.8, 11.5,  .bust,      0.95),
            (128, 20.7, 11.6,  .bust,      0.97),
            (127, 20.6, 11.7,  .bust,      0.98),
            (126, 20.5, 11.8,  .bust,      1.0),   // バスト最大
            (125, 20.3, 11.7,  .bust,      0.97),
            (124, 20.0, 11.6,  .bust,      0.95),
            (123, 19.5, 11.5,  .bust,      0.9),
            // アンダーバスト→ウエスト（1cm刻み）
            (122, 19.2, 11.3,  .underBust, 0.88),
            (121, 18.8, 11.2,  .underBust, 0.85),
            (120, 18.4, 11.0,  .underBust, 0.83),
            (119, 18.0, 10.9,  .underBust, 0.80),
            (118, 17.6, 10.7,  .underBust, 0.77),
            (117, 17.2, 10.6,  .underBust, 0.74),
            (116, 16.8, 10.4,  .underBust, 0.71),
            (115, 16.5, 10.3,  .underBust, 0.68),
            (114, 16.2, 10.2,  .waist,     0.85),
            (113, 16.0, 10.2,  .waist,     0.90),
            (112, 15.7, 10.1,  .waist,     0.95),
            (111, 15.5, 10.1,  .waist,     1.0),   // ウエスト最細
            (110, 15.5, 10.1,  .waist,     1.0),
            (109, 15.5, 10.1,  .waist,     1.0),
            // ウエスト→ヒップ（1cm刻み）
            (108, 15.6, 10.1,  .abdomen,   0.78),
            (107, 15.8, 10.2,  .abdomen,   0.76),
            (106, 16.0, 10.2,  .abdomen,   0.74),
            (105, 16.2, 10.3,  .abdomen,   0.75),
            (104, 16.6, 10.3,  .abdomen,   0.76),
            (103, 17.0, 10.4,  .abdomen,   0.78),
            (102, 17.5, 10.4,  .abdomen,   0.79),
            (101, 18.0, 10.5,  .abdomen,   0.80),
            (100, 18.6, 10.5,  .hip,       0.82),
            ( 99, 19.2, 10.5,  .hip,       0.85),
            ( 98, 19.7, 10.6,  .hip,       0.88),
            ( 97, 20.2, 10.6,  .hip,       0.92),
            ( 96, 20.6, 10.7,  .hip,       0.96),
            ( 95, 21.0, 10.7,  .hip,       1.0),   // ヒップ最大
            ( 94, 20.9, 10.7,  .hip,       0.98),
            ( 93, 20.8, 10.6,  .hip,       0.97),
            ( 92, 20.5, 10.5,  .hip,       0.95),
            ( 91, 20.0, 10.4,  .hip,       0.92),
            ( 90, 19.5, 10.2,  .hip,       0.88),
            // ヒップ→脚（1cm刻み）
            ( 89, 19.0, 10.0,  .leg,       0.7),
            ( 88, 18.5,  9.8,  .leg,       0.65),
            ( 87, 18.0,  9.5,  .leg,       0.6),
            ( 86, 17.5,  9.3,  .leg,       0.55),
            ( 85, 17.0,  9.0,  .leg,       0.5),
            ( 84, 16.5,  8.8,  .leg,       0.48),
            ( 83, 16.0,  8.6,  .leg,       0.45),
            ( 82, 15.5,  8.4,  .leg,       0.42),
            ( 81, 15.1,  8.2,  .leg,       0.40),
            ( 80, 14.8,  8.1,  .leg,       0.38),
            ( 79, 14.5,  8.0,  .leg,       0.36),
            ( 78, 14.3,  7.9,  .leg,       0.34),
            ( 77, 14.1,  7.9,  .leg,       0.32),
            ( 76, 14.0,  7.8,  .leg,       0.3),
        ]
